    ...
    translation: {
      ...
      "modules": {
        ...
        "policy": {
          ...
          "subtitle": "Understand any policy in plain language",
          "placeholder": "Paste a policy text, or type a policy name (e.g., 'New Education Policy 2020')...",
          "analyzing": "Analyzing policy...",
          "modes": {
            "simple": "📖 Explain Simply",
            "simplePrompt": "Explain this policy in simple, everyday language",
            "benefits": "👥 Who Benefits?",
            "benefitsPrompt": "Focus on who benefits and who is negatively affected by this policy",
            "prosCons": "⚖️ Pros & Cons",
            "prosConsPrompt": "Give a detailed and balanced analysis of the pros and cons of this policy",
            "eli10": "🧒 ELI10",
            "eli10Prompt": "Explain this policy as if you're talking to a 10-year-old child"
          }
        },
        "community": {
      ...
      "modules": {
        "conflict": {
          ...
          "settlement": {
            ...
            "referralTitle": "🔗 कानूनी रूप से बाध्यकारी स�        "schemes": {
          "title": "सरकारी योजनाएं",
          "subtitle": "सरकारी कल्याणकारी योजनाओं की खोज करें, समझें और उनके लिए आवेदन करें",
          "welfareDiscovery": "कल्याणकारी खोज",
          "scholarAi": "स्कॉलर एआई",
          "policyAdvisor": "नीति सलाहकार",
          "verifiedPath": "सत्यापित पथ",
          "howCanAssist": "मैं क्या सहायता कर सकता हूँ?",
          "chatSubtitle": "पात्रता, दस्तावेज़ आवश्यकताओं या पोर्टल पहुँच के बारे में पूछें।",
          "verifyingPolicy": "नीति सत्यापित की जा रही है...",
          "dataDisclaimer": "भारतीय राष्ट्रीय पोर्टल (india.gov.in) से प्राप्त डेटा",
          ...
          "items": {
            "pmay": {
              "name": "पीएम आवास योजना (PMAY)",
              "category": "आवास",
              "desc": "सभी के लिए किफायती आवास — ईडब्ल्यूएस (EWS), एलआईजी (LIG) और एमआईजी (MIG) श्रेणियों के लिए रियायती गृह ऋण और निर्माण अनुदान।",
              "eligibility": "वार्षिक आय ₹18 लाख (MIG-II) तक। परिवार में कोई पक्का घर नहीं।",
              "howToApply": "pmaymis.gov.in पर ऑनलाइन आवेदन करें या अपने निकटतम सीएससी (CSC) केंद्र पर जाएं।"
            },
            "pmjay": {
              "name": "आयुष्मान भारत (PM-JAY)",
              "category": "स्वास्थ्य",
              "desc": "माध्यमिक और तृतीयक देखभाल अस्पताल में भर्ती के लिए प्रति परिवार प्रति वर्ष ₹5 लाख तक का मुफ्त स्वास्थ्य बीमा।",
              "eligibility": "एसईसीसी (SECC) 2011 डेटा में सूचीबद्ध परिवार — वंचित परिवार और श्रमिक श्रेणियां।",
              "howToApply": "mera.pmjay.gov.in पर अपनी पात्रता जांचें। किसी भी आयुष्मान भारत एचडब्ल्यूसी (HWC) से ई-कार्ड प्राप्त करें।"
            },
            "pmkisan": {
              "name": "पीएम-किसान",
              "category": "कृषि",
              "desc": "तीन समान किस्तों में छोटे और सीमांत किसान परिवारों को प्रति वर्ष ₹6,000 की प्रत्यक्ष आय सहायता।",
              "eligibility": "कृषि योग्य भूमि वाले सभी भूमि-धारक किसान परिवार।",
              "howToApply": "आधार और भूमि रिकॉर्ड के साथ pmkisan.gov.in पर पंजीकरण करें।"
            },
            "mudra": {
              "name": "पीएम मुद्रा योजना",
              "category": "व्यवसाय",
              "desc": "सूक्ष्म/छोटे व्यवसायों के लिए ₹10 लाख तक का संपार्श्विक-मुक्त ऋण।",
              "eligibility": "गैर-कृषि आय-सृजन गतिविधि के लिए व्यवसाय योजना वाला कोई भी भारतीय नागरिक।",
              "howToApply": "किसी भी बैंक, एनबीएफसी (NBFC), या एमएफआई (MFI) में आवेदन करें।"
            },
            "skill": {
          ...
          "applicationBridge": "आवेदन प्रक्रिया",
